<template>
  <div class="product-stats-prototype">
    <!-- 页面标题 -->
    <div class="page-header">
      <h2>商品统计原型预览</h2>
      <p class="page-description">这是商品统计功能的原型展示，使用模拟数据</p>
    </div>
    ...
    <el-card class="stats-card" shadow="hover" style="margin-top: 20px">
      <el-tabs v-model="activeTab" class="stats-tabs">
        ...
        <el-tab-pane label="成交量统计" name="orders">
          ...
          <el-row :gutter="20" class="overview-cards">
            ...
            <el-col :span="6">
              <div class="overview-card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)">
                ...
                <div class="overview-content">
                  <div class="overview-value">{{ orderOverview.avgOrderValue }}</div>
          ...
          <el-row :gutter="20" style="margin-top: 20px">
            <el-col :span="24">
              <el-card shadow="never">
                ...
                <el-table :data="productOrderRanking" border stripe highlight-current-row @row-click="handleProductClick">
                  <el-table-column type="index" label="排名" width="60" align="center" />
                  <el-table-column prop="productName" label="商品名称" min-width="200">
                    <template #default="{ row }">
                      <span class="product-name-link">{{ row.productName }}</span>
                    </template>
                  </el-table-column>
          ...
          <!-- 点击商品后的订单构成弹窗 -->
          <el-dialog v-model="productDetailVisible" :title="`订单构成 - ${selectedProduct?.productName || ''}`" width="800px">
            <div v-if="selectedProduct" class="product-detail-content">
              ...
              <!-- 达人/BD订单构成明细 -->
              <el-table :data="productOrderDetail" border stripe style="margin-top: 20px">
          ...
          <el-row :gutter="20" style="margin-top: 20px">
            <el-col :span="24">
              <el-card shadow="never">
                ...
                <el-table :data="bdContribution" border stripe>
                  <el-table-column type="index" label="排名" width="60" align="center" />
          ...
          <el-row :gutter="20" style="margin-top: 20px">
            <el-col :span="24">
              <el-card shadow="never">
                ...
                <el-table :data="influencerRanking" border stripe>
                  <el-table-column type="index" label="排名" width="60" align="center" />
          ...
          <el-row :gutter="20" style="margin-top: 20px">
            <el-col :span="12">
              <el-card shadow="never">
                ...
                <el-table :data="productSampleStats" border stripe max-height="400">
                  <el-table-column type="index" label="排名" width="60" align="center" />
            ...
            <el-col :span="12">
              <el-card shadow="never">
                ...
                <el-table :data="bdSampleStats" border stripe max-height="400">
                  <el-table-column type="index" label="排名" width="60" align="center" />
