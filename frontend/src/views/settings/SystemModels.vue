...
const tableData = ref([
  ...
  },
  {
    ...
    fields: [
      ...
      { field: 'categoryId', type: 'ObjectId', ref: 'ProductCategory', description: '商品类目' },
      { field: 'gradeId', type: 'ObjectId', ref: 'ProductGrade', description: '商品等级' },
      { field: 'name', type: 'String', required: true, description: '商品名称' },
      { field: 'tiktokSku', type: 'String', description: 'TikTok SKU' },
      { field: 'tiktokProductId', type: 'String', required: true, description: 'TikTok商品ID' },
  ...
  },
  {
    ...
    fields: [
      ...
      { field: 'monthlySalesCount', type: 'Number', default: 0, description: '月销件数' },
      { field: 'avgVideoViews', type: 'Number', default: 0, description: '视频均播' },
      ...
      { field: 'sampleStatus', type: 'String', description: '样品状态: pending/sent/received/refused' },
      ...
      { field: 'fulfillmentUpdatedBy', type: 'ObjectId', ref: 'User', description: '履约更新人' },
      { field: 'fulfillmentUpdatedAt', type: 'Date', description: '履约更新时间' },
      ...
      { field: 'adPromotionUpdatedBy', type: 'ObjectId', ref: 'User', description: '投流更新人' },
      { field: 'adPromotionUpdatedAt', type: 'Date', description: '投流更新时间' },
      { field: 'isOrderGenerated', type: 'Boolean', default: false, description: '是否出单' },
      { field: 'orderCount', type: 'Number', description: '出单数量' },
      { field: 'creatorId', type: 'ObjectId', ref: 'User', description: '创建人' },
      { field: 'createdAt', type: 'Date', description: '创建时间' },
      { field: 'updatedAt', type: 'Date', description: '更新时间' }
    ]
