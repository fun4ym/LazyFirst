export default {
  ...
  samplePublic: {
    ...
    lineSyncEmpty: 'No LINE contacts to display',
    lineSyncHowTo: 'How to Bind',
    lineSyncGuideTitle: 'How to Bind LINE',
    lineSyncGuideStep1: 'Scan the Procurement LINE QR code with LINE to add friend',
    lineSyncGuideStep2: 'Send this page identification code to procurement staff',
    lineSyncGuideStep3: 'Procurement staff will complete binding in the backend',
    lineSyncGuideStep4: 'Return to this page to view the binding status',
    procurementQrTitle: 'Procurement LINE',
    procurementQrDesc: 'Scan to add procurement staff for binding or changes',
    officialQrTitle: 'Official LINE Account',
    officialQrDesc: 'Follow the official account for latest updates',
    bound: 'Bound',
    unbound: 'Unbound',
