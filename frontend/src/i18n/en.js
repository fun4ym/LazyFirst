export default {
  line: {
    ...
    bound: 'Bound',
    unbound: 'Unbound',
    bindingCode: 'LINE Code',
    bindingDialogTitle: 'LINE Binding',
    roleInfluencer: 'Influencer',
    roleSeller: 'Seller',
    yourCode: 'Your binding code',
    generateCode: 'Generate code',
    regenerate: 'Regenerate',
    copyCode: 'Copy code',
    copyFriendLink: 'Copy add-friend link',
    codeGenerated: 'Binding code generated',
    copied: 'Copied to clipboard',
    unbind: 'Unbind',
    unbindConfirm: 'Are you sure you want to unbind this LINE account?',
    unbindSuccess: 'Unbound',
    bindingStep1: '1. Add the LINE Official Account as a friend',
    bindingStep2: '2. Send the code above in chat to complete binding'
  },
  linePush: {
    btn: 'LINE Push',
    title: 'LINE Campaign Push',
    audienceSection: 'Audience',
    previewSection: 'Flex Card Preview',
  ...
  lineOverview: {
    ...
    boundTotal: 'Bound Friends',
    boundInfluencer: 'Influencers',
    boundSeller: 'Sellers',
    monthPush: 'Pushes This Month',
    pushTimes: 'times',
    messageCount: 'Messages',
    quota: 'Monthly Quota',
    remaining: 'Remaining',
    quotaNormal: 'Quota healthy',
    quotaWarn: 'Quota almost used up',
  ...
  menu: {
    ...
    aiModels: 'AI Models Configuration',
    ...
    promptPlaceholder: 'Enter video generation prompt...',
  ...
  samplePublic: {
    ...
    loading: 'Loading...',
    lineSyncTitle: 'LINE Sync / ซิงค์ LINE',
    lineSyncSub: 'LINE binding status of this shop\'s contacts / สถานะการผูก LINE ของผู้ติดต่อร้านค้า',
    lineSyncNotice: 'To make changes, please scan the QR code to contact the purchasing department / หากต้องการเปลี่ยนแปลง กรุณาสแกน QR Code ติดต่อฝ่ายจัดซื้อ',
    lineSyncQrAlt: 'LINE QR Code / QR Code LINE',
    lineSyncEmpty: 'No LINE contacts to display / ยังไม่มีรายชื่อผู้ติดต่อ LINE',
    lineSyncHowTo: 'How to Bind / วิธีผูกบัญชี',
    lineSyncGuideTitle: 'How to Bind LINE / วิธีผูกบัญชี LINE',
    bindMethodTitle: 'Binding Method / วิธีการผูกบัญชี',
    bindMethodSub: 'Add official account and contact procurement staff for binding code / เพิ่มบัญชีทางการและติดต่อฝ่ายจัดซื้อขอรหัสผูกบัญชี',
    bindStep1Title: '1. Add Official LINE Account / 1. เพิ่มบัญชี LINE ทางการ',
    bindStep1Desc: 'Scan the QR code on the right to follow the official LINE account / สแกน QR Code ด้านขวาเพื่อติดตามบัญชี LINE ทางการ',
    bindStep2Title: '2. Contact Procurement Staff / 2. ติดต่อเจ้าหน้าที่ฝ่ายจัดซื้อ',
    bindStep2Desc: 'After adding Procurement LINE, ask staff for the binding code / หลังจากเพิ่ม LINE ฝ่ายจัดซื้อ ให้ขอรหัสผูกบัญชีจากเจ้าหน้าที่',
    lineSyncGuideStep1: 'Scan the Procurement LINE QR code with LINE to add friend / ใช้ LINE สแกน QR Code「LINE ฝ่ายจัดซื้อ」เพื่อเพิ่มเพื่อน',
    lineSyncGuideStep2: 'Send this page identification code to procurement staff / ส่งรหัสประจำตัวของหน้านี้ให้เจ้าหน้าที่ฝ่ายจัดซื้อ',
    lineSyncGuideStep3: 'Procurement staff will complete binding in the backend / เจ้าหน้าที่ฝ่ายจัดซื้อจะดำเนินการผูกบัญชีในระบบ',
    lineSyncGuideStep4: 'Return to this page to view the binding status / กลับมาตรวจสอบสถานะที่หน้านี้',
    procurementQrTitle: 'Procurement LINE / LINE ฝ่ายจัดซื้อ',
    procurementQrDesc: 'Scan to add procurement staff / สแกนเพื่อเพิ่มเพื่อนเจ้าหน้าที่ฝ่ายจัดซื้อ',
    officialQrTitle: 'Official LINE Account / บัญชี LINE ทางการ',
    officialQrDesc: 'Follow the official account for latest updates / ติดตามบัญชีทางการเพื่อรับข่าวสารล่าสุด',
    bound: 'Bound / ผูกแล้ว',
    unbound: 'Unbound / ยังไม่ผูก',
    recordTitle: 'Sample Record Detail',
    backToList: 'Back to List',
    influencerAccountLabel: 'Influencer',
    followerLabel: 'Followers',
    gmvLabel: 'GMV',
    dateLabel: 'Apply Date',
    statusLabel: 'Fulfillment Status',
    trackingLabel: 'Tracking No.',
    logisticsLabel: 'Logistics',
    orderCountLabel: 'Orders',
    videoLabel: 'Fulfillment Video',
    adPromotionLabel: 'Ad Promotion',
    adPromoted: 'Promoted',
    noAdPromoted: 'Not Promoted',
    historyLabel: 'Previous Submissions',
    editStatus: 'Edit Fulfillment Status',
    selectStatus: 'Select Status',
    saveStatus: 'Save',
    refusalReasonPlaceholder: 'Enter the reason for rejection',
    statusUpdated: 'Status updated',
    recordNotFound: 'Record not found or no permission',
  ...
  aiModel: {
    // Menu
    menu: 'AI Model Configuration',
    // Page title
    pageTitle: 'AI Model Management',
    // Action buttons
    add: 'Add Model',
    createTitle: 'Create AI Model',
    editTitle: 'Edit AI Model',
    // Search and filter
    searchPlaceholder: 'Search model name/description',
    type: 'Model Type',
    provider: 'Provider',
    name: 'Model Name',
    config: 'API Config',
    ...
    apiKey: 'API Key',
    apiKeyTip: 'API key for authentication',
    apiSecret: 'API Secret',
    apiSecretTip: 'API secret for authentication',
    baseUrl: 'Base URL',
    baseUrlPlaceholder: 'e.g., https://api.openai.com/v1',
    baseUrlTip: 'Base URL for API service, empty for provider default',
    modelId: 'Model ID',
    modelIdPlaceholder: 'e.g., gpt-4, sd-2.1',
    maxTokens: 'Max Tokens',
    temperature: 'Temperature',
    extraConfig: 'Extra Config',
    extraConfigPlaceholder: 'Additional configuration in JSON',
    extraConfigTip: 'Custom configuration parameters in JSON format',
    descriptionPlaceholder: 'Enter model description',
    defaultModel: 'Default Model',
    setAsDefault: 'Set as default',
    defaultModelTip: 'When set as default, workspace will prioritize this model',
    // Model types
    typeVideo: 'Video Generation',
    typeText: 'Text Generation',
    ...
    inactive: 'Inactive',
    // Validation messages
    inputName: 'Please enter model name',
    ...
    confirmDelete: 'Are you sure to delete model "{name}"?',
  ...
  ai_maker: {
    ...
    package_b: 'Package B',
    package_c: 'Package C',
    select_influencer: 'Select Influencer',
    influencer_name: 'Influencer Name',
    search_influencer: 'Search Influencer',
    select: 'Select',
    upload_photo: 'Upload Photo',
    generate_views: 'Generate Views',
    generate_views_success: 'Generate views successfully',
    generate_views_failed: 'Failed to generate views',
    views_preview: 'Views Preview',
    regenerate: 'Regenerate',
    confirm: 'Confirm Save',
    digital_human_saved: 'Digital human saved successfully',
    front_view: 'Front',
    side_view: 'Side',
    back_view: 'Back',
    ...
    style: 'Style',
    human: 'Human Appearance',
    animated_human: 'Animated Human',
    product_only: 'Product Only',
    normal: 'Normal',
    crazy: 'Crazy',
    digital_human: 'Digital Human',
    select_digital_human: 'Select Digital Human',
    prompt_preview: 'Prompt Preview',
    duration: 'Duration',
    seconds: 'Seconds',
    generate_video: 'Generate Video',
    generate_video_success: 'Video generation task created',
    generate_video_failed: 'Failed to generate video',
    ...
    confirm_delete_template: 'Are you sure to delete this prompt template?',
    ...
    digital_human_management: 'Digital Human Management'
  },
  chromeExtension: {
    title: 'Chrome Extension',
    subtitle: 'TikTok influencer data collector — import influencer data while browsing TikTok',
    download: 'Download Extension',
    version: 'Version',
    features: 'Core Features',
    featureSearchTitle: 'Batch Import from Search',
    featureSearchDesc: 'Select influencers on search results, batch import to system',
    featureProfileTitle: 'Profile Page Import',
    featureProfileDesc: 'View historical data on profile page, one-click import or update',
    featureVideoTitle: 'Video Page Import',
    featureVideoDesc: 'Sidebar import while watching videos, no workflow interruption',
    install: 'Installation',
    step1Title: 'Download',
    step1Desc: '<span class="ce-highlight">Download</span> the extension zip and <span class="ce-highlight">extract</span> to a local folder',
    step2Title: 'Load Extension',
    step2Desc: 'Open <span class="ce-highlight">chrome://extensions/</span>, enable <span class="ce-highlight">Developer Mode</span>, load the extracted folder',
    step3Title: 'Login',
    step3Desc: 'Click the <span class="ce-highlight">extension icon</span>, enter your system username and password',
    step4Title: 'Start Using',
    step4Desc: 'Open TikTok, login once and enjoy seamless access for <span class="ce-highlight">7 days</span>',
    collectedData: 'Collected Data',
    collectedDataDesc: 'Manage influencer data collected by the extension',
    keyword: 'Keyword',
    keywordPlaceholder: 'TikTok ID / Nickname',
    ...
    estimatedGmv: 'Est. GMV',
    monthlySalesCount: 'Monthly Sales',
    collectTime: 'Collection Time',
    syncTime: 'Sync Time',
    actions: 'Actions',
    confirmSync: 'Confirm to sync this record?',
    confirmBatchSyncTitle: 'Confirm Batch Sync',
    confirmBatchSyncMsg: 'Confirm to sync {count} selected records?',
    confirmDelete: 'Confirm to delete this record?',
    confirmBatchDeleteTitle: 'Confirm Batch Delete',
    confirmBatchDeleteMsg: 'Confirm to delete {count} selected records?',
    syncSuccess: 'Sync completed',
    deleteSuccess: 'Deleted successfully',
    batchSyncDone: 'Sync done: {success} success, {fail} failed',
    batchDeleteDone: 'Delete done: {success} success, {fail} failed',
    pleaseSelect: 'Please select data first',
    syncBtn: 'Sync',
    deleteBtn: 'Del',
